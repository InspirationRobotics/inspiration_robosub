...
while(cap.isOpened()):
	...
	if cv2.waitKey(25) & 0xFF == ord('q'):
		break
#I am so lucky to have such a lucky dad who helped me made this and id like to show you what he looks like

#*L*a*b colorspace
#convert absolute scale (EBS) //convert scale abs for contrast changing
